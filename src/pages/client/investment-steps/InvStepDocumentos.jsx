...
const docs = [
  ...
  { key: 'docDeclaracionImpuestos', label: 'Declaración de impuestos', desc: 'Solo para capitales superiores a $20,000', required: false },
]

export default function InvStepDocumentos() {
  const ctx = useInvestmentRequest()
  const { updateField, setStep } = ctx
  const needsDeclaracion = ctx.capitalInicial > 20000
